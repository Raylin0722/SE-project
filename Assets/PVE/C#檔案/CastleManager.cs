...
public class CastleManager : MonoBehaviour{
    ...
    private float[] x=new float[12]{15.0f,15.0f,15.0f,15.0f,13.0f,13.0f,15.0f,14.88f,15.73f,15.06f,15.11f,15.11f};
    private float[] y=new float[12]{-1.2f,-1.2f,-1.2f,-1.2f,-1.2f,-1.0f,-1.08f,-1.13f,-0.70f,-0.84f,-1.07f,-1.07f};
