...
public class CharacterManage : MonoBehaviour{
    ...
    int[] Seq_1_2 = { 1, -1, 4, 2, 2, 2, 4, 2, 5, 1, 2, 5, 2, 2, 1, 4, 5 };
    ...
    private void Character_Location(){
        Location W1 = new Location{position = new Vector2(-672f,-280f),offset = 271.0f};
        Location_List.Add(W1);
        Location W2 = new Location{position = new Vector2(-672f,-281f),offset = 271.0f};
        Location_List.Add(W2);
        Location W3 = new Location{position = new Vector2(-673f,-285f), offset = 271.0f};
        Location_List.Add(W3);
        Location W4 = new Location{position = new Vector2(-671f,-284f), offset = 271.0f};
        Location_List.Add(W4);
        Location W5 = new Location{position = new Vector2(-670f,-288f),offset = 271.0f};
        Location_List.Add(W5);
        Location W6 = new Location{position = new Vector2(-673f,-301f),offset = 271.0f};
        Location_List.Add(W6);
        Location W7 = new Location{position = new Vector2(-666f,-282.8f),offset = 271.0f};
        Location_List.Add(W7);
        Location B1 = new Location{position = new Vector2(-672f,-280f),offset = 271.0f};
        Location_List.Add(B1);
        Location B2 = new Location{position = new Vector2(-673f,-284f),offset = 271.0f};
        Location_List.Add(B2);
        Location B3 = new Location{position = new Vector2(-673f,-285f),offset = 271.0f};
        Location_List.Add(B3);
        Location B4 = new Location{position = new Vector2(-672f,-297.195f),offset = 271.0f};
        Location_List.Add(B4);
        Location B5 = new Location{position = new Vector2(-673f,-274.385f),offset = 271.0f};
        Location_List.Add(B5);
        Location B6 = new Location{position = new Vector2(-665.8f,-296f),offset = 271.0f};
        Location_List.Add(B6);
        Location B7 = new Location{position = new Vector2(-670f,-281.9f),offset = 271.0f};
        Location_List.Add(B7);
        Location S1 = new Location{position = new Vector2(-671.5f,-274.5f),offset = 271.0f};
        Location_List.Add(S1);
        Location S2 = new Location{position = new Vector2(-673.3f,-280.5f),offset = 271.0f};
        Location_List.Add(S2);
        Location S3 = new Location{position = new Vector2(-673f,-296f),offset = 271.0f};
        Location_List.Add(S3);
        Location S4 = new Location{position = new Vector2(-674.7f,-284.6f),offset = 271.0f};
        Location_List.Add(S4);
        Location S5 = new Location{position = new Vector2(-673.1f,-269.3f),offset = 271.0f};
        Location_List.Add(S5);
        Location S6 = new Location{position = new Vector2(-673f,-299f),offset = 271.0f};
        Location_List.Add(S6);
        Location S7 = new Location{position = new Vector2(-681.6f,-268.3f),offset = 271.0f};
        Location_List.Add(S7);
        Location M1 = new Location{position = new Vector2(-672f,-270f),offset = 271.0f};
        Location_List.Add(M1);
        Location M2 = new Location{position = new Vector2(-680.8f,-275.4f),offset = 271.0f};
        Location_List.Add(M2);
        Location M3 = new Location{position = new Vector2(-673f,-281.9f),offset = 271.0f};
        Location_List.Add(M3);
        Location M4 = new Location{position = new Vector2(-651.8f,-281.8f),offset = 271.0f};
        Location_List.Add(M4);
        Location M5 = new Location{position = new Vector2(-665.5f,-281.9f),offset = 271.0f};
        Location_List.Add(M5);
        Location M6 = new Location{position = new Vector2(-673f,-301f),offset = 271.0f};
        Location_List.Add(M6);
        Location M7 = new Location{position = new Vector2(-664.5f,-286f),offset = 271.0f};
